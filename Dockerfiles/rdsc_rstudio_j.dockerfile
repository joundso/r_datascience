...
ARG \
    ...
    ##   or: https://dailies.rstudio.com/rstudio/apple-blossom/server/noble-amd64/
    RSTUDIO_VERSION="2025.12.0-daily-335"
...
RUN quarto add kapsner/authors-block --no-prompt; \
    quarto add edvinsyk/quarto-landscape --no-prompt
